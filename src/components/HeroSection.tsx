        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          >
            <h1 className="font-montserrat text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 text-white">
              <span className="text-accent-purple ink-effect inline-block pr-2">Искусство</span> на
              <span className="text-accent-purple ink-effect inline-block pl-2">твоей коже</span>
            </h1>
            <p className="text-lg md:text-xl text-neutral-gray mb-8 max-w-xl mx-auto lg:mx-0">
              Тату студия ChernilnyyStyle – это профессиональные мастера, современное оборудование и индивидуальный подход к каждому клиенту.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button size="lg" className="bg-accent-purple hover:bg-accent-purple/80 gap-2">
          ...
          >
            <div className="relative">
              ...
              <img 
                src="https://images.unsplash.com/photo-1611501267726-3ba49d429e12?q=80&w=1000" 
