      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="text-neutral-gray max-w-2xl mx-auto">
            Команда профессионалов с богатым опытом. Каждый мастер
            специализируется на определенных стилях и техниках.
          </p>
        </div>
...
const MasterCard: React.FC<MasterCardProps> = ({
  ...
  return (
    <Card
      className={`bg-card/50 backdrop-blur-sm border border-border/50 transition-all duration-700 ease-out`}
      style={{
